function createHynogram(inferredStates)
% added the function thing to call in the main.m 
% 
...
% create a folder to put the hypnogram plot 
[status, msg, msgID] = mkdir('HypnogramPlots');
cd HypnogramPlots
